...
#             self.unfolded_data = asrootpy( self.unfoldObject.Hreco( self.error_treatment ) )
    ...
    def get_covariance_matrix(self):
        '''
        Get the statistical covariance matrix from all contributions
        ...
        if self.unfolded_data is not None:
            ...
            # Create statistical correlation matrix
            ...
            norm_cor_matrix = matrix(u.correlation_matrix(norm_values_correlated) )
            ...
            return norm_cov_matrix, norm_cor_matrix
        else:
