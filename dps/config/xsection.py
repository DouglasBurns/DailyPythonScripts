...
class XSectionConfig():
	...
	def __fill_defaults__( self ):
		...
		# self.path_to_unfolding_histograms = '/storage/ec6821/DailyPythonScripts/new/DailyPythonScripts/unfolding/13TeV_debug/'
		...
		self.higgs_file = path_to_files + 'central/TTH_Inclusive_M-125_' + str( self.luminosity ) + 'pb_PFElectron_PFMuon_PF2PATJets_PFMET.root'
		...
		self.systematic_group_hadronisation = [
			'TTJets_hadronisation',
			'TTJets_scale',
			'TTJets_ue',
			'TTJets_hdamp',
