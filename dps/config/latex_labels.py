...
variables_latex = {
    ...
    'lepton_pt': '\ensuremath{ p_{\mathrm{T}}^\mathrm{\ell} }',
    'lepton_pt_+': '\ensuremath{ p_{\mathrm{T}+}^\mathrm{\ell} }',
    'lepton_pt_-': '\ensuremath{ p_{\mathrm{T}-}^\mathrm{\ell} }',
    'lepton_eta': '\ensuremath{ \eta^\mathrm{\ell} }',
    'abs_lepton_eta': '\ensuremath{ |\eta^\mathrm{\ell}| }',
    'abs_lepton_eta_coarse': '\ensuremath{ |\eta^\mathrm{\ell}| }',
    'abs_lepton_eta_muonBins': '\ensuremath{ |\eta^\mathrm{\ell}| }',
...
measurements_latex = {
    ...
    'TTJets_madgraphMLM'        : r'\textsc{MG5}\_a\textsc{MC@NLO-LO \raisebox{.2ex}{+} Pythia}',
    'TTJets_powhegPythia8'      : r'\textsc{Powheg \raisebox{.2ex}{+} Pythia}',
    'TTJets_powhegHerwig'       : r'\textsc{Powheg \raisebox{.2ex}{+} Herwig\raisebox{.2ex}{++}}',
    'TTJets_amcatnloPythia8'    : r'\textsc{MG5}\_a\textsc{MC@NLO-NLO \raisebox{.2ex}{+} Pythia}',

    'TTJets_powhegPythia8_withMCTheoryUnc': r'With MC theoretical uncertainties',
    # 'TTJets_powhegPythia8_withMCTheoryUnc': r'\textsc{Powheg \raisebox{.2ex}{+} Pythia}',
    ...
    'TTJets_petersonFrag'       : 'Peterson fragmentation model',
    ...
    'TTJets_QCDbased_erdOn'     : 'CR (QCD-based erdOn)',
    'TTJets_GluonMove'          : 'CR (Gluon Move)',
    'TTJets_CR_GluonMove_erdOn' : 'CR (Gluon Move erdOn)',
...
systematics_latex = {
    ...
    'PileUp'                    : 'Additional interactions',
    'BJet'                      : 'b tagging efficiency',
    'JES'                       : 'JES',
    'JER'                       : 'JER',
    'luminosity'                : 'Integrated luminosity',
    'V+Jets_cross_section'      : 'V+jets cross section',
    'SingleTop_cross_section'   : 'Single top quark cross section',
    'QCD_cross_section'         : 'QCD bkg cross section',
    'QCD_shape'                 : 'QCD bkg shape ',
    'PDF'                       : 'PDF ',
    'TTJets_topPt'              : 'Top quark \ensuremath{\pt}',

    'TTJets_mass'               : 'Top quark mass',
    'TTJets_scale'              : 'Renormalization and factorization scales',
    'TTJets_matching'           : 'ME/PS matching',
    ...
    'TTJets_CR'                 : 'Color reconnection',
    'TTJets_CR_erdOn'           : 'Color reconnection (erdOn)',
    'TTJets_CR_QCDbased_erdOn'  : 'Color reconnection (QCD-based erdOn)',
    'TTJets_CR_GluonMove'       : 'Color reconnection (Gluon move)',
    'TTJets_CR_GluonMove_erdOn' : 'Color reconnection (Gluon move erdOn)',
    'inputMC'                   : 'Simulated sample size',
    'central'                   : '',
    'systematic'                : '',
    'statistical'               : '',

    'Stat_normalisedXsection_inputMC' : 'Simulated sample size',
    'Stat' : 'statistics',
    'Stat_normalisedXsection' : 'Simulated sample size',
    'Total' : 'Combined',
